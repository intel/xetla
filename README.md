...
> [!IMPORTANT]
<span style="font-size: 24px; font-weight: bold;">The alternative project CUTLASS will include all XeTLA features, refer: [Cutlass-Fork](https://github.com/codeplaysoftware/cutlass-fork).</span>
