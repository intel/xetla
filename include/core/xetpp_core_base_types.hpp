...
/// 
    ...
    concept xetpp_vector_ref = __ESIMD_NS::detail::is_simd_view_type_v<Ta> && 
                               std::is_same_v<typename Ta::element_type, Ty> &&
                               (N == __ESIMD_NS::shape_type<Ta>::type::Size_x * __ESIMD_NS::shape_type<Ta>::type::Size_y);
#else
...
/// 
    ...
    concept xetpp_matrix_ref = __ESIMD_NS::detail::is_simd_view_type_v<Ta> && 
                               std::is_same_v<typename Ta::element_type, Ty> &&
